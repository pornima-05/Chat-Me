...
import com.example.testapplication2.Fragments.ChatsFragment;
import com.example.testapplication2.Fragments.ProfileFragment;
import com.example.testapplication2.Fragments.StatusFragment;
import com.example.testapplication2.Fragments.UsersFragment;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.subscription:
                // Handle the click on the "Subscription" menu item
